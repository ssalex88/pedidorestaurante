    ...
    <div className='w-full h-[100px] flex justify-between items-center px-4 md:px-8'>
        ...
        <form action="" className='w-[45%] h-[50px] bg-white flex items-center px-5 gap-[20px] rounded-md shadow-xl md:w-[70%]' onSubmit={(e) => e.preventDefault()}>
            ...
            <input 
              ...
              className='w-[100%] outline-none text-[14px] md:text-[18px]' 
              onChange={(e) => setInput(e.target.value)} 
              value={input}
            />
        </form>
        <div className='w-[50px] h-[50px] bg-white flex justify-center items-center rounded-md shadow-xl relative cursor-pointer' onClick={() => setShowCart(true)}>
